...
BEGIN
    ...
    IF UPPER(IN_CONTRACT_TYPE) = 'NEW' THEN
        ...
        IF UPPER(IN_INSURANCE_TYPE) = 'LTR' THEN
            ...
            -- 26-28
            SET v_raw_cols = CONCAT(v_raw_cols, 'COLUMN_26, COLUMN_27, COLUMN_28, ');
            SET v_proc_cols = CONCAT(v_proc_cols, 'COLUMN_26, COLUMN_27, COLUMN_28, ');

            -- 29-31 (Target specific)
            SET v_raw_cols = CONCAT(v_raw_cols, 'NULL, NULL, NULL');
            SET v_proc_cols = CONCAT(v_proc_cols, 'COLUMN_29, COLUMN_30, COLUMN_31');
        ...
        ELSEIF UPPER(IN_INSURANCE_TYPE) = 'GEN' THEN
            ...
            -- 21-23 (Target specific)
            SET v_raw_cols = CONCAT(v_raw_cols, 'NULL, NULL, NULL');
            SET v_proc_cols = CONCAT(v_proc_cols, 'COLUMN_21, COLUMN_22, COLUMN_23');
        END IF;
