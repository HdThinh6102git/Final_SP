...
BEGIN
    ...
    IF v_raw_cols != '' AND v_proc_cols != '' THEN
        ...
        -- 22. Insert into Temporary Table
        ...
        -- 2.4. Build sql query insert processed table
